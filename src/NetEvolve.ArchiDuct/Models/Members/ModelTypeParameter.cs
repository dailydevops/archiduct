...
public sealed class ModelTypeParameter : ModelEntityBase
{
    ...
    /// <inheritdoc />
    internal ModelTypeParameter(ITypeParameter parameter, ModelMemberAdvancedBase parentEntity)
        : base(
    ...
    /// <inheritdoc />
    internal ModelTypeParameter(ITypeParameter parameter, ModelTypeBase parentEntity)
        : base(
            $"{parentEntity.Id.Replace("M:", "G:", OrdinalIgnoreCase)}.{parameter.Name}",
            parameter.Name,
            $"{parentEntity.FullName}.{parameter.Name}",
