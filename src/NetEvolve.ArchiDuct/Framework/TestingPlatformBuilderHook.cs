...
public static class TestingPlatformBuilderHook
{
    ...
    /// </summary>
    /// <param name="testApplicationBuilder">The test application builder instance implementing <see cref="Microsoft.Testing.Platform.Builder.ITestApplicationBuilder"/>.</param>
    /// <param name="_">The command line arguments passed to the test application (unused by this implementation).</param>
    /// <remarks>
